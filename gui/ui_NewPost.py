...
class Ui_newPost(object):
    def setupUi(self, newPost):
        ...
        self.commitBtn = QPushButton(self.itemsBox)
        self.commitBtn.setObjectName(u"commitBtn")
        self.commitBtn.setGeometry(QRect(400, 130, 121, 31))
        self.commitBtn.setFont(font)
        self.commitBtn.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        self.commitBtn.setStyleSheet(u"")
        ...
        self.createDraftBtn.setGeometry(QRect(740, 50, 111, 31))
    ...
    def retranslateUi(self, newPost):
        ...
        self.commitBtn.setText(QCoreApplication.translate("newPost", u"\u0627\u0639\u062a\u0628\u0627\u0631 \u0633\u0646\u062c\u06cc (\u06f3)", None))
